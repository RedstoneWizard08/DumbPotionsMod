...
public class TwentyFivePercentEffectMobEffect extends MobEffect {
    public TwentyFivePercentEffectMobEffect() {
    ...
    public void applyInstantenousEffect(Entity source, Entity indirectSource, LivingEntity entity, int amplifier, double health) {
        ...
        if (percent == 1) {
            ...
            entity.hurt(
                    new DamageSource(entity.level().registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypes.GENERIC)) {
