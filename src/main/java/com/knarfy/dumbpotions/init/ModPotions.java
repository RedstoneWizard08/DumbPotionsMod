...
public class ModPotions {
    ...
    public static void load() {
        ...
        SYSTEM_ZEE_POTION = Registry.register(BuiltInRegistries.POTION,
        ...
        ALL = List.of(CORRUPTION_POTION, REVEALING_POTION, TWENTY_FIVE_PERCENT_POTION, FURIOUS_COCKTAIL, SHRIEKING,
                SHAPESHIFTING_POTION, THEME_SONG_POTION, XVII_POTION, LAUNCHING_POTION, SYSTEM_ZEE_POTION,
