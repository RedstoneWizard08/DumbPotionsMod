...
public class SubscribeScreen extends BaseOwoHandledScreen<FlowLayout, SubscribeHandler> {
    ...
    protected void build(FlowLayout rootComponent) {
        ...
        rootComponent.child(
                Containers.verticalFlow(Sizing.fixed(600), Sizing.fixed(400))
                        .child(Components.label(Component.literal("Chat Window")).positioning(Positioning.absolute(16, 13)))
                        .child(Components.box(Sizing.fixed(568), Sizing.fixed(1)).color(Color.WHITE).positioning(Positioning.absolute(16, 42)))
