...
public class GivePotionsCommand {
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register(Commands.literal("givepotions").executes(arguments -> {
            ...
            var box = namedItem(new ItemStack(Items.PURPLE_SHULKER_BOX, 1), Component.literal("Dumb Potion Ideas").withStyle(ChatFormatting.LIGHT_PURPLE, ChatFormatting.BOLD));
