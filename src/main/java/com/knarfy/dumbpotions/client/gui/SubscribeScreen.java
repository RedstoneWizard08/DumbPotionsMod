...
public class SubscribeScreen extends BaseOwoHandledScreen<FlowLayout, SubscribeHandler> {
    ...
    protected void build(FlowLayout rootComponent) {
        ...
        rootComponent.child(Containers.verticalFlow(Sizing.fill(60), Sizing.fill(60))
                ...
                .child(Components.button(Component.literal("I'm already subscribed"), this::onPreSub).margins(Insets.of(2)))
    ...
    private void onPreSub(ButtonComponent _button) {
        assert Minecraft.getInstance().player != null;
        ...
        parent.child(new MessageComponent(player, "I'm already subscribed!", HorizontalAlignment.LEFT).get());
        parent.child(new MessageComponent("Knarfy", "Hey, thanks for the support! <3", HorizontalAlignment.LEFT).get());
    ...
    private void showExit(FlowLayout parent) {
